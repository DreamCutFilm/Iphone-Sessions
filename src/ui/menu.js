...
// Те, чого немає в нижніх вкладках. Дублювати їх тут немає сенсу: вкладки
// видно завжди, і другий список тих самих слів лише змушує щоразу
// перевіряти, чи це не два різні місця.
//
// Лишається все інше — те, що доти відкривалося тільки збоку: «Техніка» й
// «Команда» з екрана кошторисів, «Проєкти фірми» з екрана проєктів. Людина
// не мусить знати, з якого кута застосунку її пускають у власний каталог.
//
// Під кожним пунктом — один рядок про те, що всередині.
//
